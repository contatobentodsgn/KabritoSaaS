...
export function QuickAccess({
  ...
  const cards: QuickCard[] = [
    { icon: Flame, title: "Pautas quentes", sub: "Temas em alta hoje", meta: `${counts.trends} temas`, href: `/trends${lens}`, cta: "Ver pautas" },
    ...
    { icon: Type, title: "Headlines", sub: "Ganchos prontos para adaptar", meta: `${counts.headlines} headlines`, href: `/headlines${lens}`, cta: "Ver headlines" },
