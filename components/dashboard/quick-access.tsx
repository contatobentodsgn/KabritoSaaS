...
export function QuickAccess({
  ...
  const cards: QuickCard[] = [
    ...
    { cardKey: "suggestions", icon: Lightbulb, title: "Sugestões de post", sub: "Ideias prontas para adaptar", meta: `${counts.suggestions} disponíveis`, href: `/daily-briefing/${editionId}#sugestoes`, cta: "Abrir sugestões" },
    { cardKey: "headlines", icon: Type, title: "Headlines", sub: "Ganchos prontos para adaptar", meta: `${counts.headlines} headlines`, href: `/headlines${lens}`, cta: "Ver headlines" },
    { cardKey: "visual", icon: ImageIcon, title: "Análise visual", sub: "Padrões visuais reproduzíveis", meta: `${counts.visual} padrões`, href: `/daily-briefing/${editionId}#visual`, cta: "Ver visual" },
    { cardKey: "prompts", icon: Sparkles, title: "Prompts", sub: "Biblioteca de prompts prontos", meta: "Biblioteca", href: "/prompts", cta: "Abrir prompts" },
