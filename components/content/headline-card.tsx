    ...
    <Card>
      <CardHeader className="flex flex-row items-start justify-between gap-2">
        <div className="space-y-2">
          <p className="font-serif text-lg leading-snug text-foreground">{headline.headline}</p>
        ...
        <FavoriteButton entityType="headline" entityId={headline.id} initial={favorited} />
      </CardHeader>
